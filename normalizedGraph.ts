...
export const normalizedGraph: Record<string, MessageRaw> = {
  ...
  // 2: {
  //   message: "Мы инициативная группа, которая хочет помочь молодым специалистам стать грамотнее в области интеллектуальной собственности!",
  // },
  // [beforePayment]: {
  ...
  // },
  // 49: {
  //   message: "Рекомендую продолжить и более подробно узнать об особенностях и  процедуре патентования!",
  //   buttons: [
  //     {
  //       text: "Далее",
  //       to: "50",
