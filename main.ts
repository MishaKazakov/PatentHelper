...
const normalizedGraph: Record<string, MessageRaw> = {
  0: {
    message:
      "Здравствуйте! Я бот- консультант по интеллектуальному праву, я помогаю молодым учёным понять, как закрепить за собой право на результаты своей интеллектуальной деятельности.",
    buttons: [
      {
        text: "Давай начнем!",
        to: "1",
  ...
  50: {
    ...
    buttons: [
      ...
      {
        text: "Пошлины за объекты и поддержание патента в силе",
        to: "59",
      },
      {
